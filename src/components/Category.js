        ...
        for (let i = 1; i <= pagesCount; i++) {
            items.push(
                <Pagination.Item key={i} active={i == pgNum}
                                 href={'/category/' + catName + '?pn=' + (i) + '&ps=' + pageSize}
                >
                    {i}
                </Pagination.Item>,
            );
            ...
            <Container className='w-75 mx-auto mt-5'>
                <Pagination className=''>
                    <Pagination.First disabled={pgNum == 1}
                                      href={'/category/' + catName + '?pn=' + 1 + '&ps=' + pageSize}
                    />
                    <Pagination.Prev disabled={pgNum == 1}
                                     href={'/category/' + catName + '?pn=' + (pageNum - 1) + '&ps=' + pageSize}
                    />
                    ...
                    <Pagination.Last disabled={pgNum == pagesCount}
                                     href={'/category/' + catName + '?pn=' + pagesCount + '&ps=' + pageSize}
                    />
                </Pagination>
            </Container>
        )
